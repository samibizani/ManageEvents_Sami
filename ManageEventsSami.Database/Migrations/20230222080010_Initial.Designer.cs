// <auto-generated />
using System;
using ManageEventsSami.Database;
...
namespace ManageEventsSami.Database.Migrations
{
    ...
    [Migration("20230222080010_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ManageEventsSami.Domain.Auth", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ManageEventsSami.Domain.Event", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ManageEventsSami.Domain.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ManageEventsSami.Domain.Auth", b =>
                {
                    b.HasOne("ManageEventsSami.Domain.User", "User")
                        .WithOne()
                        .HasForeignKey("ManageEventsSami.Domain.Auth", "UserId")
